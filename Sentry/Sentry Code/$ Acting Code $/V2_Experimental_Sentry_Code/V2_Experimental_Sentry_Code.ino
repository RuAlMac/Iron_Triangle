...
//Output Variables
int alarmClockRelay = 23;
int beaconLightRelay = 24;
...
bool verboseSerialOutput = true; //This is for prototyping only; change to true to get detailed information about LDR sensor values in the Serial monitor
