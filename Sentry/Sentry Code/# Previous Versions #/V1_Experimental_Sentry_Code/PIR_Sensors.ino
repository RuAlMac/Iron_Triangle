void checkPirSensor1() {
  ...
  if (pir1State == true) {
    ...
    if (digitalRead(pir1) == LOW) {
      pir1State = false;
      alarmLevel = alarmLevel - 1;
      Serial.println("PIR 1: Motion Stopped");
    }
  }
...
void checkPirSensor2() {
  ...
  if (pir2State == true) {
    ...
    if (digitalRead(pir2) == LOW) {
      pir2State = false;
      alarmLevel = alarmLevel - 1;
      Serial.println("PIR 2: Motion Stopped");
    }
  }
...
void checkPirSensor3() {
  if ( (digitalRead(pir3) == HIGH) && (pir3State == false) ) {
    ...
    pir3State = true;
    alarmLevel = alarmLevel + 1;
    Serial.println("PIR 3: Motion Detected");
  }
  ...
  if (pir3State == true) {
    ...
    if (digitalRead(pir3) == LOW) {
      pir3State = false;
      alarmLevel = alarmLevel - 1;
      Serial.println("PIR 3: Motion Stopped");
    }
  }
...
void checkPirSensor4() {
  if ( (digitalRead(pir4) == HIGH) && (pir4State == false) ) {
    ...
    pir4State = true;
    alarmLevel = alarmLevel + 1;
    Serial.println("PIR 4: Motion Detected");
  }
  ...
  if (pir4State == true) {
    ...
    if (digitalRead(pir4) == LOW) {
      pir4State = false;
      alarmLevel = alarmLevel - 1;
      Serial.println("PIR 4: Motion Stopped");
    }
  }
